...
public class BajaServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
       try {
           //Este documento no esta en uso todavia
           //
           //
           //
           //
           ...
           //
            ...
            String borrado = "INSERT INTO cliente(nombre,apellido,telefono,direccion) VALUES (?,?,?,?)";

            PreparedStatement s = conexion.prepareStatement(borrado);
